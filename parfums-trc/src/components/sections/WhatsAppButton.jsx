...
const WhatsAppButton = () => {
  return (
    <a
      href="https://wa.me/+528712584098?text=Hola%2C%20tengo%20una%20pregunta!"
      target="_blank"
    ...
    >
      <div className="relative">
        ...
        {/* Tooltip */}
        <div className="absolute right-16 top-1/2 -translate-y-1/2 bg-white text-gray-800 px-4 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap text-sm font-medium">
          ¿Necesitas ayuda?
